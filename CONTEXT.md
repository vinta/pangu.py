...
Automatic whitespace insertion between CJK and half-width characters, delivered as a text engine and a CLI. Python port of the [pangu.js](https://github.com/vinta/pangu.js) v9 text-spacing algorithm.
