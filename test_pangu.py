...
class PanguTestCase(unittest.TestCase):
    ...
    def test_at(self):
        ...
        self.assertEqual(u'前面 @vinta 後面', pangu.spacing('前面@vinta後面'))
        self.assertEqual(u'前面 @vinta 後面', pangu.spacing('前面 @vinta 後面'))

        # http://weibo.com/vintalines
        self.assertEqual(u'前面 @陳上進 後面', pangu.spacing('前面@陳上進 後面'))
        self.assertEqual(u'前面 @陳上進 後面', pangu.spacing('前面 @陳上進 後面'))
        self.assertEqual(u'前面 @陳上進 tail', pangu.spacing('前面 @陳上進tail'))

    def test_hash(self):
        self.assertEqual(u'前面 #H2G2 後面', pangu.spacing('前面#H2G2後面'))
        self.assertEqual(u'前面 #銀河便車指南 後面', pangu.spacing('前面#銀河便車指南 後面'))
        self.assertEqual(u'前面 #銀河便車指南 tail', pangu.spacing('前面#銀河便車指南tail'))
        self.assertEqual(u'前面 #銀河公車指南 #銀河拖吊車指南 後面', pangu.spacing('前面#銀河公車指南 #銀河拖吊車指南 後面'))

        self.assertEqual(u'前面 #H2G2# 後面', pangu.spacing('前面#H2G2#後面'))
        self.assertEqual(u'前面 #銀河閃電霹靂車指南# 後面', pangu.spacing('前面#銀河閃電霹靂車指南#後面'))

    def test_dollar(self):
        self.assertEqual(u'前面 $ 後面', pangu.spacing('前面$後面'))
        self.assertEqual(u'前面 $ 後面', pangu.spacing('前面 $ 後面'))

        self.assertEqual(u'前面 $100 後面', pangu.spacing('前面$100後面'))

    def test_percent(self):
        self.assertEqual(u'前面 % 後面', pangu.spacing('前面%後面'))
        self.assertEqual(u'前面 % 後面', pangu.spacing('前面 % 後面'))

        self.assertEqual(u'前面 100% 後面', pangu.spacing('前面100%後面'))
    ...
    def test_ampersand(self):
        ...
        self.assertEqual(u'Vinta&Mollie', pangu.spacing('Vinta&Mollie'))
        self.assertEqual(u'Vinta & 陳上進', pangu.spacing('Vinta&陳上進'))
        self.assertEqual(u'陳上進 & Vinta', pangu.spacing('陳上進&Vinta'))

        self.assertEqual(u'得到一個 A&B 的結果', pangu.spacing('得到一個A&B的結果'))
    ...
    def test_underscore(self):
        self.assertEqual(u'前面_後面', pangu.spacing('前面_後面'))
        self.assertEqual(u'前面 _ 後面', pangu.spacing('前面 _ 後面'))
    ...
    def test_plus(self):
        ...
        self.assertEqual(u'得到一個 C++ 的結果', pangu.spacing('得到一個C++的結果'))
